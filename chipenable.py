...
class chipenable(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "chipenable")
        ...
        # Variables
        ##################################################
        self.tx_gain_var = tx_gain_var = 35
        self.square_test_freq = square_test_freq = 7000
        self.samp_rate = samp_rate = 5000000
        self.rx_gain_var = rx_gain_var = 30
        self.carrier_freq2 = carrier_freq2 = 2465000000
        self.carrier_freq = carrier_freq = 2482000000

        ##################################################
        # Blocks
        ##################################################
        self._tx_gain_var_range = Range(10, 45, 1, 35, 50)
        ...
        self._carrier_freq_range = Range(2400000000, 2500000000, 3, 2482000000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1024, self.samp_rate, 50000, 5000, firdes.WIN_HAMMING, 6.76))
    ...
    def get_carrier_freq2(self):
        return self.carrier_freq2

    def set_carrier_freq2(self, carrier_freq2):
        self.carrier_freq2 = carrier_freq2
...
def main(top_block_cls=chipenable, options=None):
