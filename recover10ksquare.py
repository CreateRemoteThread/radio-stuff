...
class recover10ksquare(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "recover10ksquare")
        ...
        # Variables
        ##################################################
        self.carrier_default = carrier_default = 2477764200
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1024, self.samp_rate, 10000, 2500, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=recover10ksquare, options=None):
